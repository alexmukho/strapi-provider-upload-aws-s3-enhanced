...
const ACCESS_LEVEL = ['private','public-read','public-read-write','authenticated-read'];
...
const getAccessLevel = (config) => {
  if(config.accessLevel){
    ...
    throw Error(`The S3 access level: ${config.accessLevel} is not valid. Please choose from: private, public-read, public-read-write, authenticated-read`)
  }
